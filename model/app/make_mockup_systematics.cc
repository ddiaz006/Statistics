...
double _tag_var_sys[]   = {0.02,0.1,0.2};
double _ipsig_sys[]     = {0.02,0.02,0.1};
double _ta_sys[]        = {0.02,0.02,0.1};
double _amax_sys[]      = {0.02,0.02,0.1};
double _egs_sys[]       = {0.02,0.02,0.04};
double _mes_sys[]       = {0.02,0.02,0.04};
